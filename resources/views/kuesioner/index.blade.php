...
<body>
    ...
    <div class="flex flex-col items-center gap-6 p-8 w-full max-w-4xl mx-auto">
        <!-- Header Section -->
        <p class="text-gray-600 text-center text-lg font-bold">Silakan isi kuesioner untuk memberikan penilaian terhadap kinerja administrasi para tenaga kependidikan</p>
        
        <!-- Information Section -->
        <div class="w-full text-center text-lg font-semibold text-blue-600 border-2 border-blue-600 px-6 py-4 rounded-lg shadow-md">
            1. Kuesioner Kepuasan terhadap Kinerja Administrasi
        </div>
        
        <!-- Button Section -->
        <div class="w-full flex flex-col gap-4">
            <a href="{{ route('kuesioner.create') }}" class="block text-center font-semibold px-6 py-3 bg-green-600 text-white rounded-lg transition-all hover:bg-green-700 shadow-md">
                Mulai
            </a>
